 ...
 * Difficulty: Easy
 * Description: There are n kids with candies. You are given an integer array candies, where each candies[i]
...
public class KidsWithTheGreatestNumberOfCandies {
    public List<Boolean> kidsWithCandies(int[] candies, int extraCandies) {
        ...
        for (int i = 0; i < candies.length; i++) ans.add(candies[i] + extraCandies >= max);
